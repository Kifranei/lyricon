...
internal object BgEffectConfig {
    ...
    private val OS3_PHONE_DARK = Config(
        points = floatArrayOf(0.78f, 0.18f, 1.0f, 0.82f, 0.92f, 1.0f, 0.18f, 0.92f, 1.0f, 0.22f, 0.18f, 1.0f),
        colors1 = floatArrayOf(0.15f, 0.20f, 0.82f, 0.58f, 0.24f, 0.14f, 0.58f, 0.54f, 0.36f, 0.20f, 0.74f, 0.48f, 0.10f, 0.33f, 0.88f, 0.52f),
        colors2 = floatArrayOf(0.08f, 0.27f, 0.95f, 0.62f, 0.70f, 0.24f, 0.78f, 0.54f, 0.13f, 0.36f, 0.93f, 0.56f, 0.04f, 0.22f, 0.82f, 0.58f),
        colors3 = floatArrayOf(0.72f, 0.30f, 0.82f, 0.52f, 0.30f, 0.20f, 0.68f, 0.50f, 0.76f, 0.34f, 0.72f, 0.48f, 0.16f, 0.22f, 0.76f, 0.58f),
